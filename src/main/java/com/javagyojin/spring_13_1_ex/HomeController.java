package com.javagyojin.spring_13_1_ex;
...
import com.javagyojin.spring_13_1_ex.member.Member;
...
//	public String joinData(@RequestParam("id") String id, @RequestParam("pw") String pw, @RequestParam("name") String name, 
